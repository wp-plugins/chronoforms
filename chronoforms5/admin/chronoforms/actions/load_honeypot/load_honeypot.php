...
Class LoadHoneypot extends \GCore\Admin\Extensions\Chronoforms\Action{
	...
	public static function config(){
		echo \GCore\Helpers\Html::formStart('action_config load_honeypot_action_config', 'load_honeypot_action_config_{N}');
		echo \GCore\Helpers\Html::formSecStart();
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][{N}][method]', array('type' => 'dropdown', 'label' => l_('CF_HONEYPOT_METHOD'), 'options' => array('static' => l_('CF_STATIC'), 'dynamic' => l_('CF_DYNAMIC')), 'sublabel' => l_('CF_HONEYPOT_METHOD_DESC')));
