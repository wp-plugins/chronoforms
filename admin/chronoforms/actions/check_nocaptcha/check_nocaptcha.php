...
Class CheckNocaptcha extends \GCore\Admin\Extensions\Chronoforms\Action{
	...
	public static function config(){
		echo \GCore\Helpers\Html::formStart('action_config check_nocaptcha_action_config', 'check_nocaptcha_action_config_{N}');
		echo \GCore\Helpers\Html::formSecStart();
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][{N}][error]', array('type' => 'text', 'label' => l_('CF_NOCAPTCHA_ERROR'), 'class' => 'XL', 'sublabel' => l_('CF_NOCAPTCHA_ERROR_DESC')));
		echo \GCore\Helpers\Html::formLine('Form[extras][actions_config][{N}][secret_key]', array('type' => 'text', 'label' => l_('CF_NOCAPTCHA_SECRET_KEY'), 'class' => 'XL', 'sublabel' => l_('CF_NOCAPTCHA_SECRET_KEY_DESC')));
